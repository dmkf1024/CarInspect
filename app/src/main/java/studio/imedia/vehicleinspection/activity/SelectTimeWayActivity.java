...
public class SelectTimeWayActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void showDatePicker() {
        new MyDatePickerDialog(mContext, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                mMonth = monthOfYear;
                mDay = dayOfMonth;
                String yearSelected = formatNum(mYear);
                String monthSelected = formatNum(mMonth);
                String daySelected = formatNum(mDay);
    ...
    private void getCurDate() {
        ...
        mCurYear = mYear = calendar.get(Calendar.YEAR);
        mCurMonth = mMonth = calendar.get(Calendar.MONTH) + 1;
        mCurDay = mDay = calendar.get(Calendar.DAY_OF_MONTH);
